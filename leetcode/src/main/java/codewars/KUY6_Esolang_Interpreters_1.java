...
/**
 * @author ZhouJie
 * @date 2020年3月19日 下午9:24:55 
 * @Description: Esolang Interpreters #1 - Introduction to Esolangs and My First Interpreter (MiniStringFuck)
 *
	...
	题干大意：介绍了Esolang语言balabala.... 
	MiniStringFuck是一种Esolang语言，只有+和.号有程序意义，其他字符无效，+用来计数，.用来输出已计数的值对应的ASCII值字符，+每计数到256就从0重新计数；
	本题要求实现一个用来翻译MiniStringFuck字符代码的程序，输出对应的ASCII结果字符。
 */
public class KUY6_Esolang_Interpreters_1 {
